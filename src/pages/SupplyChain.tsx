...
const SupplyChain = () => {
  const navTabs = [
    ...
    { label: 'Data Management', value: 'data-management', path: '#' },
    { label: 'Data Flows', value: 'data-flows', path: '#' },
    { label: 'Model Building', value: 'model-building', path: '#' },
    { label: 'Macros', value: 'macros', path: '#' },
    { label: 'Data Visualizations', value: 'data-visualizations', path: '#' },
    { label: 'Queue Management', value: 'queue-management', path: '#' }
  ];
  ...
  return (
    ...
    >
      <div className="mb-4">
        <TabsNavigation tabs={navTabs} currentPath={window.location.pathname} />
      </div>
          ...
          <Card className="bg-white">
            ...
            <div className="h-64 p-4 flex justify-center items-center">
              <div className="text-center text-gray-500">
                <img 
                  src="/lovable-uploads/8833f7c5-a4c3-4e43-81cc-93bdf9b3a0e0.png" 
