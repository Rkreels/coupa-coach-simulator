  ...
  return (
    ...
    >
          ...
          <Card className="p-6 hover:shadow-md transition-shadow cursor-pointer">
            <div className="flex flex-col items-center text-center">
              <div className="bg-blue-100 p-3 rounded-full mb-4">
                <Settings className="h-8 w-8 text-coupa-blue" />
              </div>
              <h3 className="text-lg font-medium mb-2">General Settings</h3>
              <p className="text-gray-600 mb-4">Configure company information, branding, and global preferences.</p>
        ...
        >
          <Card className="p-6 hover:shadow-md transition-shadow cursor-pointer">
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-gray-600 mb-4">Manage users, roles, departments, and access controls.</p>
        ...
        >
          <Card className="p-6 hover:shadow-md transition-shadow cursor-pointer">
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-gray-600 mb-4">Configure payment providers, currencies, and tax settings.</p>
              <div className="flex items-center justify-center gap-2 text-yellow-600 text-sm">
                <CheckCircle className="h-4 w-4" />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
        {[
          { name: "Procurement", icon: <FileText className="h-6 w-6 text-coupa-blue" />, status: "Complete" },
          { name: "Invoicing", icon: <FileText className="h-6 w-6 text-coupa-blue" />, status: "Complete" },
          { name: "Expense Management", icon: <FileText className="h-6 w-6 text-coupa-blue" />, status: "Setup Required" },
          { name: "Sourcing", icon: <FileText className="h-6 w-6 text-coupa-blue" />, status: "In Progress" },
          { name: "Contracts", icon: <FileText className="h-6 w-6 text-coupa-blue" />, status: "Setup Required" },
          { name: "Supplier Management", icon: <FileText className="h-6 w-6 text-coupa-blue" />, status: "Complete" }
        ].map((module, index) => (
